        ...
        <tr>
          <td style="padding:20px 32px;background:${BRAND_GOLD_SOFT};border-top:1px solid #e2e8f0;font-size:11px;color:#64748b;line-height:1.5;">
            ...
            <div style="margin-top:4px;">
              <a href="https://rentalsphilly.com" style="color:#64748b;text-decoration:underline;">rentalsphilly.com</a>
              &nbsp;·&nbsp;
              <a href="https://rentalsphilly.com/privacy" style="color:#64748b;text-decoration:underline;">Privacy</a>
              &nbsp;·&nbsp;
              <a href="https://rentalsphilly.com/terms" style="color:#64748b;text-decoration:underline;">Terms</a>
            </div>
...
export function welcomeEmailHtml({ firstName, emailBody, emailSubject, settings }) {
  // `agentName` used to be a separate prop here; now we resolve identity
  // (name + phone + email + title) from settings via buildSignature, so the
  // caller doesn't have to pre-stringify it.

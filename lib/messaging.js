...
//
// Both endpoints are admin-only as of the security hardening — callers must
// be signed in. We use authedFetch which auto-attaches the Supabase access
// token AND auto-signs-out on 401 so a stale session bounces cleanly back to
// login instead of confusing the admin with "unauthenticated" errors.
//

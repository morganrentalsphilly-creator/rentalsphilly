...
//
// NOTE: there is also an app/privacy/page.jsx with identical content. Next.js
// resolves duplicate routes by the `pageExtensions` order (.tsx wins), so
// this file is what actually ships. The .jsx version is kept for safety —
// if this file is ever deleted, the .jsx takes over without a code change.
// ============================================================================

...
//
// NOTE: there is also an app/terms/page.jsx with identical content. Next.js
// resolves duplicate routes by the `pageExtensions` order (.tsx wins), so
// this file is what actually ships. The .jsx version is kept as a safety
// net — if this file is ever deleted, the .jsx takes over with no edits.
// ============================================================================
